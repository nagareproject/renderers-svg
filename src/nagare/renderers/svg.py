...
from nagare.renderers.xml import TagProp, XmlRenderer
...
class Renderer(XmlRenderer):
    ...
    audio = TagProp(
        'audio', (RUNTIME_SYNCHRONISATION_ATTRIBUTES | ANIMATION_TIMING_ATTRIBUTES | {'xlink:href', 'type'})
    )
    circle = TagProp(
        'circle',
        (
    ...
    color_profile = TagProp(
        'color-profile', (CORE_ATTRIBUTES | XLINK_ATTRIBUTES | {'local', 'name', 'rendering-intent', 'xlink:href'})
    )
    cursor = TagProp(
        'cursor',
        (
    ...
    feComponentTransfer = TagProp(
        'feComponentTransfer',
        (CORE_ATTRIBUTES | PRESENTATION_ATTRIBUTES | FILTER_PRIMITIVE_ATTRIBUTES | {'class', 'style', 'in'}),
    )
    feComposite = TagProp(
        'feComposite',
        (
    ...
    feMerge = TagProp(
        'feMerge', (CORE_ATTRIBUTES | PRESENTATION_ATTRIBUTES | FILTER_PRIMITIVE_ATTRIBUTES | {'class', 'style'})
    )
    feMergeNode = TagProp('feMergeNode', CORE_ATTRIBUTES | {'in'})
    feMorphology = TagProp(
        'feMorphology',
        (
            CORE_ATTRIBUTES
            | PRESENTATION_ATTRIBUTES
    ...
    feTile = TagProp(
        'feTile', (CORE_ATTRIBUTES | PRESENTATION_ATTRIBUTES | FILTER_PRIMITIVE_ATTRIBUTES | {'class', 'style', 'in'})
    )
    feTurbulence = TagProp(
        'feTurbulence',
        (
            CORE_ATTRIBUTES
            | PRESENTATION_ATTRIBUTES
    ...
    hatchpath = TagProp(
        'hatchpath',
        (CORE_ATTRIBUTES | GLOBAL_EVENT_ATTRIBUTES | PRESENTATION_ATTRIBUTES | STYLE_ATTRIBUTES | {'d', 'offset'}),
    )
    ...
    mpath = TagProp('mpath', (CORE_ATTRIBUTES | XLINK_ATTRIBUTES | {'externalResourcesRequired', 'xlink:href'}))
    path = TagProp(
        'path',
        (
            CONDITIONAL_PROCESSING_ATTRIBUTES
    ...
    script = TagProp(
        'script', (CORE_ATTRIBUTES | XLINK_ATTRIBUTES | {'externalResourcesRequired', 'type', 'xlink:href'})
    )
    solidColor = TagProp(
        'solidColor', (CORE_ATTRIBUTES | GLOBAL_EVENT_ATTRIBUTES | PRESENTATION_ATTRIBUTES | STYLE_ATTRIBUTES)
    )
    solidcolor = TagProp(
        'solidcolor', (CORE_ATTRIBUTES | GLOBAL_EVENT_ATTRIBUTES | PRESENTATION_ATTRIBUTES | STYLE_ATTRIBUTES)
    )
    stop = TagProp(
        'stop', (CORE_ATTRIBUTES | PRESENTATION_ATTRIBUTES | {'class', 'style', 'offset', 'stop-color', 'stop-opacity'})
    )
    ...
    view = TagProp(
        'view',
        (CORE_ATTRIBUTES | {'externalResourcesRequired', 'viewBox', 'preserveAspectRatio', 'zoomAndPan', 'viewTarget'}),
    )
